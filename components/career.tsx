                        ...
                        {intro 
                            ...
                            <div>
                                ...
                                <div className="mt-2 p-1 text-gray-800">
                                    ...
                                    <p>
                                        해당 프로젝트는 기존 Spring을 React로 완전히 바꿔야하는 프로젝트임으로 Spring과 Next 양쪽을 이해할 수 있어야 했습니다.
                                        학부시절 Spring에 대한 수업을 통해 Spring MVC에 대한 이해는 괜찮았지만, Next는 커녕 React도 잘 모르는 상태였습니다.
                                    </p><br/>
                                    <p>
                                        따라서 해당 프로젝트를 수행하기 위해서 React와 Next를 1달의 기간을 거쳐 학습하였습니다.
                                        학습의 효과로 Next.JS 환경에 빠르게 적응할 수 있었으며 하키플레이의 Next 변환 작업도 순조롭게 진행하였습니다.
                                    </p><br/>
                                    <p>
                                        이 프로젝트를 진행하며 React(Next)의 실력 향상은 물론, 기존 하키플레이의 구조를 파악해가며 Spring의 실력까지 향상할 수 있는 좋은 기회였습니다.
                                    </p>
