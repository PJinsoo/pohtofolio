...
const WidthSkills = () => {
    ...
    return(
        <>
            ...
            <Title
                title="SKILLS"
                summary= "보유한 기술 스택입니다." // "보유한 기술 스택입니다."
            ...
            <div className="grid">
                ...
                <div className="mt-4 p-4 grid grid-cols-1 border-2 rounded-lg shadow-md space-y-6 bg-gray-50">
                    <span className="text-start text-2xl border-b-2 border-gray-300 m-2 font-bold text-orange-500">Frontend</span>
                ...
                <div>
                {/* 백엔드 기술 스택 */}
                <div className="grid mt-8 p-2 border-2 rounded-lg shadow-md space-y-6 bg-gray-50">
                    <span className="text-start text-2xl border-b-2 border-gray-300 m-2 font-bold text-orange-500">Backend</span>
                    <div className="flex justify-around space-x-2">
                        <Image src={JAVA} alt="java" width={80} height={80}/>
                        <Image src={NodeJS} alt="node" width={120} height={100}/>
                        <Image src={Spring} alt="spring" width={200} height={200} />
                        <Image src={MySQL} alt="mysql" width={200} height={100} />
                    </div>
                </div>
                {/* ect... */}
                <div className="mt-8 p-4 grid grid-cols-1 border-2 rounded-lg shadow-md space-y-6 bg-gray-50">
                    <span className="text-start text-2xl border-b-2 border-gray-300 m-2 font-bold text-orange-500">etc.</span>
                    <div className="flex justify-around space-x-2">
